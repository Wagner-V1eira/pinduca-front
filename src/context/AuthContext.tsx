...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
    ...
    try {
      ...
      if (storedToken && storedUser) {
        ...
        if (
          ...
          console.warn(
            "AuthProvider: Dados de usuário no localStorage parecem inválidos."
          );
      ...
      console.error(
        "AuthProvider: Erro ao carregar dados do localStorage",
        error
      );
      localStorage.removeItem("authToken");
      localStorage.removeItem("authUser");
  ...
  const login = useCallback(
    (newToken: string, userData: UsuarioRelacionado) => {
      if (
        !userData ||
        ...
        console.error(
          "AuthProvider: Tentativa de login com dados de usuário inválidos",
          userData
        );
  ...
  console.log("[AuthProvider] Renderizando Provider com State:", {
    isLoggedIn,
